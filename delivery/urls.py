...
urlpatterns = [
    ...
    path(
    'remove_from_cart/<int:item_id>/<str:username>/',
    views.remove_from_cart,
    name='remove_from_cart'
),

path('increase_qty/<int:cartitem_id>/<str:username>/', views.increase_qty, name='increase_qty'),
path('decrease_qty/<int:cartitem_id>/<str:username>/', views.decrease_qty, name='decrease_qty'),
path('place_order/<str:username>/', views.place_order, name='place_order'),
path('ordersuccess/<str:username>/', views.ordersuccess, name='ordersuccess'),
